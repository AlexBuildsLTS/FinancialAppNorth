    ...
    return (
        <View style={[
            styles.container,
            {
                ...
                paddingTop: insets.top + 10, // Dynamic padding based on safe area
                paddingBottom: 12,
            ...
            <View style={styles.rightContainer}><AnimatedThemeIcon />
                ...
                >{profileMenuItems.map((item, index) => (
                        ...
                        >
                            ...
                            <Text style={{ color: item.isDestructive ? theme.colors.error : theme.colors.textPrimary }}>
                                {item.label}
                            </Text>
                        </Pressable>
                    ))}</DropdownMenu>
...
const styles = StyleSheet.create({
    ...
    // Add any other styles you might need for the header components
});