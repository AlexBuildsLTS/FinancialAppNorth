...
import { View, Text, ScrollView, TouchableOpacity, TextInput, Alert, ActivityIndicator, SafeAreaView, StatusBar } from 'react-native';
...
export default function InviteClientScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#0A192F]">
        ...
        <ScrollView className="flex-1 p-6" contentContainerStyle={{ paddingBottom: 100 }} keyboardShouldPersistTaps="handled">
