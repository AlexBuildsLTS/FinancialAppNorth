...
const MOCK_DATA: Transaction[] = [
  { id: '1', amount: -120.50, description: 'AWS Services', category: 'Business', date: '2023-10-25' },
  { id: '2', amount: 5000.00, description: 'Client Payment', category: 'Income', date: '2023-10-24' },
];
...
export default function TransactionsScreen() {
  ...
  const handleAdd = () => {
    ...
    const newTx = {
      ...
      amount: selectedCategory === 'Income' ? parseFloat(amount) : -parseFloat(amount),
      description,
