      ...
      <View style={[styles.budgetCard, { backgroundColor: colors.surface }]}>
        <View style={styles.budgetHeader}>
          ...
          <Text style={[styles.budgetAmount, { color: colors.text }]}>
            ${item.spent_amount.toFixed(2)} / <Text style={{ color: colors.textSecondary }}>${item.allocated_amount.toFixed(2)}</Text>
          </Text>
        </View>
        <BudgetProgressBar spent={item.spent_amount} allocated={item.allocated_amount} color={progressColor} />
