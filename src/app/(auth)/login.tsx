...
import { 
  ...
  PieChart, BarChart3, CheckCircle2, Twitter, Linkedin 
  ...
  <View className='w-full'>
      <View className='mb-16'>
          ...
          <Text className='text-[#8892B0] text-base leading-7 max-w-3xl'>
            NorthFinance is a comprehensive financial management platform designed to empower individuals and businesses with intelligent tools.
          </Text>
      </View>
