  ...
  const reports = [
    {
      ...
      icon: BarChart2,
      onPress: () => router.push(`/client/reports/profit-loss/${id}`),
    },
    {
      title: 'Balance Sheet',
      description: 'Assets, liabilities, and equity snapshot.',
      icon: PieChart,
      onPress: () => router.push(`/client/reports/balance-sheet/${id}`),
    },
    {
      title: 'Cash Flow Statement',
      description: 'Inflows and outflows from activities.',
      icon: TrendingUp,
      onPress: () => router.push(`/client/reports/cash-flow/${id}`),
    },
  ];
    ...
    <ScreenContainer>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
          ...
          >
            Select a statement to generate
          </Text>
        </View>
