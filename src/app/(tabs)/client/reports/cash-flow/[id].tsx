  ...
  return (
    <View
      style={[
        ...
        isTotal && { borderTopColor: colors.border },
      ]}
    >
      <Text
        style={[
      ...
      <Text
        style={[
          ...
          {
            fontWeight: isTotal ? 'bold' : 'normal',
            color: isTotal ? valueColor : colors.text,
          },
        ]}
      >
        {value < 0
...
export default function CashFlowScreen() {
  ...
  const cashFlowData = useMemo(() => {
    ...
    transactions.forEach((t) => {
      ...
      if (
        ['Investing', 'Purchase of Equipment', 'Sale of Asset'].includes(
          category
        )
      ) {
        investing.push(t);
      } else if (
        ['Financing', 'Loan Repayment', 'Owner Investment'].includes(category)
      ) {
        financing.push(t);
      } else {
        operating.push(t);
    ...
    const netChangeInCash =
      netFromOperating + netFromInvesting + netFromFinancing;
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        >
          ...
          <ReportRow
            ...
            value={cashFlowData.netFromOperating}
            isTotal
            colors={colors}
          />
          ...
          <ReportRow
            ...
            value={cashFlowData.netFromInvesting}
            isTotal
            colors={colors}
          />
          ...
          <ReportRow
            ...
            value={cashFlowData.netFromFinancing}
            isTotal
            colors={colors}
          />
          ...
          <ReportRow
            ...
            value={cashFlowData.netChangeInCash}
            isTotal
            colors={colors}
          />
        </View>
