...
const createStyles = (colors: { background: any; surface: any; primary: any; primaryContrast?: string; secondary?: string; text: any; textSecondary: any; tabBarActive?: string; tabBarInactive?: string; border: any; surfaceVariant: any; error?: string; success: any; warning?: string; }, isDark: boolean) =>
  StyleSheet.create({
